...
public class actLogin extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.act_login_email);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.act_login_signin_button);
        ...
        Button mEmailSignUpButton = (Button) findViewById(R.id.act_login_signup_button);
    ...
    private void gotoSignUpPage() {
        Intent signUpIntent = new Intent(getApplicationContext(),actSignup.class);
